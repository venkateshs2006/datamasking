    ...
    public void init() {
        try {
           ...
           if (userRepository.count() == 0) {
               ...
               manager.setPassword(encoder.encode("pass123"));
               manager.setRole("MANAGER");
               manager.setDepartments(Set.of("Finance", "HR"));
